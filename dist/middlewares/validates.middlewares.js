...
exports.UpdateSalaryValidator = (0, validation_1.validate)((0, express_validator_1.checkSchema)({
    ten: {
        ...
        trim: true,
        notEmpty: {
            errorMessage: messages_1.SALARY_MESSAGES.SALARY_NAME_REQUIRED
        },
        isLength: {
            options: { max: 255 },
            errorMessage: messages_1.SALARY_MESSAGES.SALARY_NAME_MAX_LENGTH
        },
        custom: {
            options: (value_1, _a) => __awaiter(void 0, [value_1, _a], void 0, function* (value, { req }) {
                var _b;
                const salaryId = (_b = req.params) === null || _b === void 0 ? void 0 : _b.id;
                const existingSalary = yield database_service_1.default.SalaryPortion.findOne({
                    ten: value,
                    _id: { $ne: new mongodb_1.ObjectId(salaryId) }
                });
                if (existingSalary) {
                    throw new Error(messages_1.SALARY_MESSAGES.SALARY_NAME_EXISTS);
                }
                return true;
            })
        }
    ...
    loai: {
        isInt: {
            errorMessage: messages_1.SALARY_MESSAGES.SALARY_TYPE_MUST_BE_INTEGER
        },
        toInt: true,
        custom: {
            options: (value) => {
            ...
            errorMessage: messages_1.SALARY_MESSAGES.SALARY_TYPE_INVALID
        }
    },
    mo_ta: {
        isString: true,
        ...
        isLength: {
            options: { max: 5000 },
            errorMessage: messages_1.SALARY_MESSAGES.SALARY_DESCRIPTION_MAX_LENGTH
        }
    },
    is_active: {
        isBoolean: {
            errorMessage: messages_1.SALARY_MESSAGES.SALARY_STATUS_MUST_BE_BOOLEAN
        },
        toBoolean: true
    },
    'tai_khoan_ke_toan.*.id_congty': {
        isMongoId: {
            errorMessage: messages_1.SALARY_MESSAGES.COMPANY_ID_INVALID
        }
    },
    'tai_khoan_ke_toan.*.id_ke_toan': {
        isMongoId: {
            errorMessage: messages_1.SALARY_MESSAGES.ACCOUNTANT_ID_INVALID
        }
    },
    tai_khoan_ke_toan: {
        custom: {
            options: (value) => __awaiter(void 0, void 0, void 0, function* () {
                ...
                for (const account of value) {
                    ...
                    if (seen.has(key)) {
                        throw new Error(messages_1.SALARY_MESSAGES.DUPLICATE_ACCOUNT_COMPANY_PAIR);
                    }
                    seen.add(key);
                }
                return true;
...
exports.editRoleValidator = (0, validation_1.validate)((0, express_validator_1.checkSchema)({
    title: {
        ...
        custom: {
            options: (value_1, _a) => __awaiter(void 0, [value_1, _a], void 0, function* (value, { req }) {
                var _b;
                const roleId = (_b = req.params) === null || _b === void 0 ? void 0 : _b.id;
                const existingRole = yield database_service_1.default.Role.findOne({
                    title: value,
                    _id: { $ne: new mongodb_1.ObjectId(roleId) }
                });
                if (existingRole) {
                    throw new Error('Tên vai trò đã tồn tại.');
                }
...
exports.updateUserValidator = (0, validation_1.validate)((0, express_validator_1.checkSchema)({
    ...
    password: Object.assign(Object.assign({}, passwordSchema), { optional: true }),
    is_active: {
        isBoolean: {
            errorMessage: 'Trạng thái hoạt động phải là kiểu boolean.'
        },
